...
namespace SGBank.Tests
{
    ...
    public class PremiumAccountTests
    {
        ...
        [TestCase("12345", "Basic Account", 100, AccountType.Premium, 250, true)]
        ...
        [TestCase("12345", "Basic Account", 100, AccountType.Premium, 100, 100, false)]
        [TestCase("33333", "Basic Account", 150, AccountType.Premium, -250, 500, true)]
        [TestCase("33333", "Basic Account", 100, AccountType.Premium, -200, -100, true)]
